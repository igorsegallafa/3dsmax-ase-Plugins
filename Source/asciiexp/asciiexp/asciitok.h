...
#define ID_PHYSIQUE					_T("*PHYSIQUE")
#define ID_PHYSIQUE_NUM_VERTASSINE	_T("*PHYSIQUE_NUMVERTEXASSIGNMENT")
#define ID_PHYSIQUE_VERT_LIST		_T("*PHYSIQUE_VERTEXASSIGNMENT_LIST")
#define ID_PHYSIQUE_NOBLEND_RIGID	_T("*PHYSIQUE_VERTEXASSIGNMENT_NONBLENDED_RIGIDTYPE")
#define ID_PHYSIQUE_BLEND_RIGID		_T("*PHYSIQUE_VERTEXASSIGNMENT_BLENDED_RIGIDTYPE")
#define ID_PHYSIQUE_NUM_NODASSINE	_T("*PHYSIQUE_VERTEXASSIGNMENT_NUMNODE")
#define ID_PHYSIQUE_NODE_LIST		_T("*PHYSIQUE_VERTEXASSIGNMENT_NODELIST")
#define ID_PHYSIQUE_NODE			_T("*PHYSIQUE_VERTEXASSIGNMENT_NODE")
